	...
	<section>
		...
		<?php query_posts("category_name=noticiaComunicacao&posts_per_page=3");?>
		<div class="principalArtigo artigo row">
			<?php
				    // Get the ID of a given category
				   // $category_noticiaComunicacao = get_cat_ID( 'notícia - Comunicação' );
				     $category_noticiaComunicacao = get_category_by_slug("noticiaComunicacao")->cat_ID;
				   

				    // Get the URL of this category
 				   $category_link_noticiaComunicacao = get_category_link( $category_noticiaComunicacao );
 				   
			?>

<!-- Print a link to this category -->

			<h2><a href="<?php echo esc_url( $category_link_noticiaComunicacao ); ?>">Notícias</a></h2>
			<article>
